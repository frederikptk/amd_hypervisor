...
int main(int argc, char** argv) {
    ...
    while (1) {
        ioctl(ctl_fd, HYPERKRAKEN_IOCTL_CREATE_GUEST, &guest_id);
        ...
        for (unsigned int i = 0; i < rand() % 256; i++) {
            ...
            switch (cmd) {
                ...
                case 4 : 
                    ...
                    ioctl(ctl_fd, HYPERKRAKEN_IOCTL_VCPU_RUN, &id_data);
                    break;
                case 5 :
                ...
                case 6 :
                    ...
                    if (r == 0) {
                        ...
                        ioctl(ctl_fd, HYPERKRAKEN_SET_MEMORY_REGION, &region);
                    }
                    if (r == 1) {
        ...
        ioctl(ctl_fd, HYPERKRAKEN_IOCTL_DESTROY_GUEST, &guest_id);
    }
